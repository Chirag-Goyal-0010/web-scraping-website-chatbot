...
--
-- Name: index_documents_on_website_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_documents_on_website_id ON public.documents USING btree (website_id);
...
CREATE UNIQUE INDEX index_websites_on_url ON public.websites USING btree (url);


--
-- Name: documents fk_rails_f6b3509a24; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.documents
    ADD CONSTRAINT fk_rails_f6b3509a24 FOREIGN KEY (website_id) REFERENCES public.websites(id);
